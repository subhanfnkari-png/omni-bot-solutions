        ...
        <div className="container mx-auto relative z-10">
          ...
          <div className="flex flex-wrap gap-3 justify-center md:justify-start">
            ...
            <div className="relative">
              ...
              <div className="absolute -top-2 -left-2 lg:-top-4 lg:-left-4 chat-bubble bg-white backdrop-blur-sm floating max-w-[140px] lg:max-w-[200px] text-xs lg:text-sm">
              ...
              <div className="absolute -top-4 -right-2 lg:-top-8 lg:-right-4 chat-bubble bg-white backdrop-blur-sm floating-delayed max-w-[130px] lg:max-w-[180px] text-xs lg:text-sm">
                <div className="flex items-start gap-2 lg:gap-3">
              ...
              <div className="hidden lg:block absolute -bottom-4 -left-4 chat-bubble bg-white backdrop-blur-sm floating max-w-[190px]">
              ...
              <div className="hidden lg:block absolute -bottom-8 -right-4 chat-bubble bg-white backdrop-blur-sm floating-delayed max-w-[200px]">
                <div className="flex items-start gap-3">
